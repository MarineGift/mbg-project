===== FILE: C:\dev\mbg-project\src\app\(app)\inbox\[id]\page.tsx =====
```tsx
...
===== MISSING: C:\dev\mbg-project\src\components\inbox\communication-detail-v2.tsx =====

===== MISSING: C:\dev\mbg-project\src\components\inbox\communication-detail.tsx =====

===== MISSING: C:\dev\mbg-project\src\components\inbox\inbox-thread.tsx =====

===== MISSING: C:\dev\mbg-project\src\components\inbox\message-card.tsx =====
