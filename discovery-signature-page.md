===== C:\dev\mbg-project\src\app\(app)\settings\email-signature\page.tsx =====
```tsx
...
===== MISSING: C:\dev\mbg-project\src\components\settings\email-signature-manager.tsx =====

===== MISSING: C:\dev\mbg-project\src\components\settings\signature-settings.tsx =====
