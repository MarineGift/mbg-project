'use client'
// src/components/industry/PromoteCompanyButton.tsx
// Phase 7-b-2: industry.paper_companies → app.parties 승격 버튼

import { useState } from 'react'
import { promoteCompanyToParty } from '@/app/actions/party'
...
export function PromoteCompanyButton({
  companyId,
  companyName,
  existingPartyId,
  existingPartyName,
  ...
  async function handlePromote() {
    setLoading(true)
    setError(null)
    const result = await promoteCompanyToParty(companyId)
