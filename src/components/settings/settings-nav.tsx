...
import {
  ...
  FileText, Send, History, ShieldCheck, PenLine, MailCheck, CalendarDays, UserCog, KeyRound, Inbox, Ban,
} from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/settings/email-blocklist', label: 'Email Blocklist',  icon: Ban },
