...
import { INBOX_PAGE_SIZE_OPTIONS } from '@/types/inbox';
...
export function InboxPagination({ page, pageSize, totalCount }: Props) {
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-3 border-t text-sm" aria-busy={isPending}>
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          variant="outline" size="icon" className="h-8 w-8"
          onClick={() => goTo(totalPages)} disabled={page >= totalPages}
          aria-label="Last"
        >
