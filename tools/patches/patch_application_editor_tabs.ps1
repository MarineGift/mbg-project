$dir = "C:\dev\mbg-project\src\app\(app)\applications\[formId]"
$client = @'
...
'@
[System.IO.File]::WriteAllText("$dir\application-editor-client.tsx", ($client -replace "`r`n","`n"))
Write-Host "WROTE application-editor-client.tsx"
$page = @'
...
'@
[System.IO.File]::WriteAllText("$dir\page.tsx", ($page -replace "`r`n","`n"))
Write-Host "WROTE page.tsx"