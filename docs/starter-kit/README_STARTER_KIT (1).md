# README — URM Platform Starter Kit (2026-05-19 v3)
...
|------|------|------|---------------------|
| **URM_MASTER_ARCHITECTURE.md** ⭐ | v2 | ~17 KB | 7분 (필수, 가장 먼저) |
| **NEXT_SESSION_KICKOFF.md** | v4 | ~13 KB | 5분 (필수) |
| **PROJECT_CONTEXT.md** | v2 | ~22 KB | 5분 (필수) |
| **DB_SCHEMA_REFERENCE.md** | v2.2 | ~39 KB | 10분 (skim) |
| **SCHEMA_GOTCHAS.md** | v3.1 | ~22 KB | 5분 (skim) |
...
| **migration_person_firm_history_2026Q2.sql** | ✅ **적용 완료 (2026-05-19)** — 119 backfill + 1900-fix |
...
### Phase 1, 3-6 — 향후 (URM_MASTER_ARCHITECTURE §6 참조)

| Phase | 산출물 | 시간 | 상태 |
|-------|--------|------|:----:|
| **1** | paper_mill / filler profile + 1,492 행 마이그레이션 | 90-120분 | 🔴 **최우선** |
...
→ 권장 시작: **Phase 1 (paper_mill/filler profile)** — URM 통일 패턴 시현의 핵심 작업.
...
### 5.9 ⚠️ PostgreSQL GREATEST NULL 함정 (Phase 2 후 발견)
```sql
