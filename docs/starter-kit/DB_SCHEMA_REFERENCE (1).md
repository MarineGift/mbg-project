...
> **버전:** 2026-05-19 v2 (Phase 2 introspection 7섹션 모두 반영 — RLS/views/triggers/indexes/function bodies/module_data 완료)
...
- v2 → v2.1 (Phase 2): 451 indexes, 128 triggers, 272 RLS policies, 5 views, 14 함수 본문 분석 (자세히는 SCHEMA_GOTCHAS §10 참조)
